...
import { getPayments, getPersonal, payBill, removeBill, updateBill } from '../../store/Bill/Bill.reducer'
...
export class Personal extends Component {
    ...
    componentDidMount(){
        this.props.getPersonal(this.props.login.home_id)
    ...
    render() {
        ...
        if(this.props.personal !== [] && this.props.user !== []){
            this.props.personal.map((response, index)=>{
                this.props.user.map((busca)=>{
                    ...
                    if(busca.id === response.responsible_id && busca.id === this.props.login.user_id ){
